...
<div>
    ...
    <!-- </p> -->
    <h1>Sourdough Parameters</h1>
    <form>
        Final Weight
        <input type="number" step="1" min="500" value="650" /><br />
        Hydration
        <input type="number" step="1" min="50" max="100" value="65" /><br />
        Starter Hydration
        <input type="number" step="1" min="50" max="200" value="100" /><br />
        Starter Percentage
        <input type="number" step="1" min="5" max="50" value="20" /><br />
        Salt Percentage
        <input type="number" step="0.1" min="0" max="3" value="2" /><br />
    </form>
</div>
<div>
    <h2>Do this...</h2>
